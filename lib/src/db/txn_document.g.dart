...
extension TxnDocumentQueryFilter
  ...
  QueryBuilder<TxnDocument, TxnDocument, QAfterFilterCondition> itemsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'items',
      ));
...
extension TxnDocumentQueryWhereDistinct
  ...
  QueryBuilder<TxnDocument, TxnDocument, QDistinct> distinctByItems() {
    return QueryBuilder.apply(this, (query) {
...
extension TxnDocumentQueryProperty
  ...
  QueryBuilder<TxnDocument, List<String>?, QQueryOperations> itemsProperty() {
    return QueryBuilder.apply(this, (query) {
